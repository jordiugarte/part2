...
public class LeftSection {
    ...
    public Button recycleBinButton = new Button(By.xpath("//td[@class='FilterItemContent']//a[contains(.,'Recycle Bin')]"));
    public Button recycleBinOptions = new Button(By.xpath("//div[@class='ProjItemMenu']"));
